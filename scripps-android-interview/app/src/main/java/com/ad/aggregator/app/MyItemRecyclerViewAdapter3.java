...
public class MyItemRecyclerViewAdapter3 extends RecyclerView.Adapter<MyItemRecyclerViewAdapter3.ViewHolder> {
    ...
    public MyItemRecyclerViewAdapter3(Context context, List<RecipeItem> items, OnFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
        mContext = context;
    }
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        holder.mContentView.setText(holder.mItem.owner);

        BaseViewModel.LoadImage(mContext, holder.mItem.image, holder.mImageView);
